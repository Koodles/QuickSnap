...
namespace CardGames
{
    public class SnapGame
    {
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				SwinGame.DrawText ("Top Card is " + top.ToString (), Color.White, "GameFont", 340, 120);
				SwinGame.DrawText ("Player 1 score: " + myGame.Score(0), Color.White, "GameFont", 0, 105);
				SwinGame.DrawText ("Player 2 score: " + myGame.Score(1), Color.White, "GameFont",670, 105);
